...
const logo = () => (
    ...
    <path
      d="M265.85 277.52l-2.75-.25c-10.25-.99-15.16-4.48-37.78-56.2l-38.35-87.59-1.17 6.94 34.93 80.65c5.37 12.18 8.55 25.36 9.13 36.31.59 11.19-1.23 19.15-12.87 19.89l-5.21.25.04.75h54.08l-.05-.75z"
    ...
    <path
      d="M183.3 210.59c-.53-2.91-1.58-5.93-1.85-8.95-.36-3.88-.21-7.94-1.4-11.57-2.15-6.57-4.47-13.06-7.19-19.34l-9.94 23.61c2.34 5.08 4.63 10.2 6.99 15.24 1.14 2.44 1.69 5.03 2.36 7.58 1.86 7.08 3.83 14.56 8.38 20.47 3.87 5.02 7.81 10.11 11.74 15.15 1.28 1.64 1.31 3.26.35 5.05-1.7 3.17-.94 5.37 2.43 6.76 1.53.63 2.42 1.68 3.22 3.05 1.53 2.6.88 5.61 1.77 8.33.55 1.67 1.96 2.65 3.3 2.77 1.02.1 2.06-1.53 2.34-2.69 1.37-5.76.92-14.12-2.18-19.4-8.64-14.72-17.28-29.37-20.32-46.06z"
    ...
    <path fill="url(#logo_svg__d)" d="M215.11 212.74h-28.84l.88 2.9h28.93z" />
    <linearGradient
      id="logo_svg__e"
      gradientUnits="userSpaceOnUse"
      x1={118.982}
